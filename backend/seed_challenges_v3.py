...

    {
        ...
        "starter_code": {
            "javascript": js_cli(
                ...
                "    // TODO: Implement dependency resolution (topological sort)\n"
                "    // Return installation order where each package appears after all its dependencies.\n"
                "    // If there is a circular dependency, log: {\"error\": \"Circular dependency detected\"}\n"
            ...
            "python": py_cli(
                ...
                "    # TODO: Implement dependency resolution (topological sort)\n"
                "    # Return installation order list. If circular dependency detected,\n"
